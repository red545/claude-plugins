...
# --- Usage ---
usage() {
  echo "Usage: scrape.sh <channel-or-video-url> [--count N]"
  echo ""
  echo "  <url>       YouTube channel URL or video URL"
  echo "  --count N   Number of videos to fetch (default: 5)"
  exit 1
}
...
# --- Call Apify sync API ---
echo "Scraping YouTube (last $COUNT videos)..." >&2
